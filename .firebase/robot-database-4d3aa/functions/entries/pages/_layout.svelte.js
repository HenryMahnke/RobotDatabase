import { c as create_ssr_component, a as compute_rest_props, g as getContext, b as spread, e as escape_attribute_value, d as escape_object, f as escape, v as validate_component, h as add_attribute, s as setContext, i as validate_store, j as subscribe } from "../../chunks/ssr.js";
import { p as page } from "../../chunks/stores.js";
import { v as validate_dynamic_element, a as validate_void_dynamic_element, i as is_void } from "../../chunks/Indicator.svelte_svelte_type_style_lang.js";
  ...
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: ({ hidden, toggle }) => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-1n8u0bq">FRC Robot Database</span>`;
        }
        ...
        {},
        {
          default: () => {
            ...
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/Data" }, {}, {
              default: () => {
                return `Database`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/enterData" }, {}, {
              default: () => {
                return `enterData`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/signIn" }, {}, {
              default: () => {
                return `Log in`;
              }
