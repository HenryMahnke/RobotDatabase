...
<div>
	<Card img={pineapple} class="mb-4">
		<h5 id="teamNum" class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
			Team 254
		</h5>
		<p id="name" class="mb-3 font-normal text-gray-700 dark:text-gray-400 leading-tight">
			CheesyPoofs
		</p>
		<p>World EPA Rank:</p>
		<p>Unitless EPA:</p>
